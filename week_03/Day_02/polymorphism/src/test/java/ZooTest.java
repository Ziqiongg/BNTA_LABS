...
public class ZooTest {
    ...
    @BeforeEach
    void setup(){
        janitor = new Janitor("test janitor", "janitor");
        ticketSeller = new TicketSeller("test seller", "ticket seller");
        reptileKeeper = new Keeper("test keeper 1", "reptile keeper");
        mammalKeeper = new Keeper("test keeper 2", "mammal keeper");
        birdKeeper = new Keeper("test keeper 3", "bird keeper");
